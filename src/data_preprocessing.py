...
class DataProcessor:
    ...
    def select_features(self, df):
        try:
            ...
            num_features_to_select = self.config_path["data_processing"][
                "no_of_features"
            ]
            ...
            logger.info(
                f"Top {num_features_to_select} features are : {top_10_features}"
            )
...
if __name__ == "__main__":
    processor = DataProcessor(
        TRAIN_FILE_PATH, TEST_FILE_PATH, CONFIG_PATH, PROCESSED_DIR
    )
    processor.process()
